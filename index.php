                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            ...
                            // print_r($image); информация о изображении                
                         ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__info">
                            ...
                            <div class="contacts__mail">
                                ...
                                <a href="mailto:mirdetstva@gmail.com"><?php the_field("address", 2); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                             <?php echo do_shortcode('[contact-form-7 id="13ea5c7" title="Форма для отправки"]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
